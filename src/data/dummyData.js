...
export const projects = [
  {
    ...
    production_repo: "https://github.com/OpenHand/hand-v2-production",
    ...
    vision:
      "Prosthetic that grows with the child - modular, repairable, and understandable by the family that uses it.",
  ...
  },
  {
    ...
    production_repo: "https://github.com/OpenHand/neck-support-production",
  ...
  },
  {
    ...
    video_description_link: null,
    production_repo: "https://github.com/OpenHand/grip-assist-production",
    status: "FINAL",
    version: "1.0.0",
    description:
  ...
  },
  {
    ...
    manuals: null,
    video: null,
    software_githubLink: "https://github.com/OpenHand/thumb-module",
    video_description_link: null,
    status: "ONGOING",
    production_repo: "https://github.com/OpenHand/thumb-module-production",
    version: "0.8.0",
    description:
      "<p>A standalone opposable thumb module with ball-and-socket joint and independent servo actuation. Designed to snap into the OpenHand v2 palm or work as a retrofit for other prosthetic platforms.</p>",
    stories: [],
    is_hidden: false,
    mechanical_github_repo: "https://github.com/OpenHand/thumb-mech",
    electrical_github_repo: null,
    software_github_repo: "https://github.com/OpenHand/thumb-module",
  ...
  },
  {
    ...
    software_githubLink: "https://github.com/OpenHand/wrist-unit",
    video_description_link: null,
    status: "FINAL",
    version: "1.2.0",
    description:
      "<p>A compact powered wrist rotation module using a worm gear mechanism. Provides 180° pronation/supination with position feedback. Compatible with the OpenHand v2 socket.</p>",
    stories: [],
    production_repo: "https://github.com/OpenHand/wrist-unit-production",
    is_hidden: false,
    mechanical_github_repo: "https://github.com/OpenHand/wrist-mech",
    electrical_github_repo: "https://github.com/OpenHand/wrist-elec",
    software_github_repo: "https://github.com/OpenHand/wrist-unit",
  ...
  },
  {
    ...
    stories: [],
    is_hidden: false,
    mechanical_github_repo: "https://github.com/OpenHand/socket-system",
    production_repo: null,
    electrical_github_repo: null,
    software_github_repo: null,
  ...
  },
  {
    ...
    manuals: null,
    video: null,
    software_githubLink: "https://github.com/OpenHand/emg-app",
    video_description_link: null,
    status: "ONGOING",
    version: "0.3.0",
    description:
      "<p>A cross-platform mobile app (React Native) that connects via BLE to the OpenHand control board. Allows users to calibrate EMG thresholds, adjust grip patterns, and run diagnostics without a laptop.</p>",
    stories: [],
    is_hidden: false,
    mechanical_github_repo: null,
    electrical_github_repo: null,
    software_github_repo: "https://github.com/OpenHand/emg-app",
    production_repo: null,
  ...
  },
  {
    ...
    manuals: null,
    video: null,
    software_githubLink: "https://github.com/OpenHand/print-profiles",
    video_description_link: null,
    status: "FINAL",
    version: "2.0.0",
    description:
      "<p>Tested and validated slicer profiles for all OpenHand parts across popular printers (Ender 3, Prusa i3, Bambu A1). Includes material settings for PLA, PETG, and TPU with recommended infill and support strategies.</p>",
    stories: [],
    is_hidden: false,
    mechanical_github_repo: null,
    electrical_github_repo: null,
    software_github_repo: "https://github.com/OpenHand/print-profiles",
    vision: "Hit print and know it will work - no guesswork, no failed parts.",
    readme_mechanical: null,
    production_repo: "https://github.com/OpenHand/print-profiles-production",
    readme_electrical: null,
    readme_software: null,
  },
  {
...
export const contributors = [
  ...
  },
  {
    ...
    quote: "Every child deserves Prosthetic that fits their world.",
  ...
  },
  {
    ...
    bio: "Full-stack developer and firmware engineer. Built the OpenHand calibration app and BLE communication layer. Advocates for clean, well-documented code in open-source medical devices.",
  ...
  },
  {
    ...
    bio: "Technical writer and community manager. Wrote the OpenHand assembly manual, translated documentation into Polish and German, and manages the contributor onboarding process.",
