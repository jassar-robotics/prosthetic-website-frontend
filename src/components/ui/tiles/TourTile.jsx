...
const TourTile = ({ data, type = 'Tour' }) => {
  const [isHovered, setIsHovered] = useState(false);
  const { slug, name, total_price, image, difficulty, duration, tag, isBadged, stars } = data;
  ...
  return (
    <Link
      ...
      className="relative  bg-white  cursor-pointer group flex justify-between   flex-col  h-[420px] gap-2 rounded-lg overflow-hidden hover:shadow-lg shadow-md m-2 md:m-0   transition-all duration-500 border  border-N100  border-0.5"
    >
      <div className="flex flex-col gap-2 justify-start h-full ">
        ...
        <div className="flex  flex-col justify-between   h-[170px] pb-4 ">
          <div className="flex flex-col  gap-2 justify-start items-start ">
            <div className="flex gap-1  items-end px-4 ">
              ...
              <div className="text-sm font-light">
                Starting From
                <span className="text-base text-B500"> USD {Math.floor(total_price)}</span>
              </div>
            </div>
          ...
          <div className="px-4 flex flex-col relative ">
            <div className="flex flex-col gap-2 ">
              <div className="flex sm:justify-between justify-end  items-center mb-1 w-full "></div>
