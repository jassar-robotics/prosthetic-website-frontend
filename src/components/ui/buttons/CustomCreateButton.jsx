...
function CustomCreateButton() {
  ...
  return (
    <Link
      ...
      className=" group flex gap-2 items-center justify-center w-48 text-sm  px-2 bg-white shadow-lg rounded-md text-B500 hover:bg-transparent border border-transparent hover:border-white hover:text-white hover:shadow-none transition-colors duration-500"
      onClick={() => {
