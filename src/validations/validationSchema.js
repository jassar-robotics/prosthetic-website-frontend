...
export const emailSchema = z.string().trim().nonempty('This Field is required.').email();
...
export const phoneNumberSchema = z
  ...
  .nonempty('This Field is required.')
  .regex(/^(97|98)\d{8}$/, {
    message: 'Must be a valid phone number starting with 98 or 97 and 10 digits long.',
  });
